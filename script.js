document.addEventListener('DOMContentLoaded', () => {
    ...
    const labelTermsText = document.getElementById('label-terms-text');
    ...
    function setLanguage(lang) {
        ...
        if (labelTermsText) {
            labelTermsText.textContent = data.labelTerms;
        }
