document.addEventListener('DOMContentLoaded', () => {
    ...
    // ----- OYUN DURUM YÖNETİMİ (Değişiklik yok) -----
    ...
    // ----- DİL VE ARAYÜZ FONKSİYONLARI (Değişiklik yok) -----
    ...
    // ----- OYUN AKIŞI FONKSİYONLARI (Çeviri düzeltmeleri yapıldı) -----
    ...
    function handleLevelWin() { 
        ...
        if (level.prize) { 
            ...
            const msg = `${getText('level')} ${level.level} ${getText('isComplete')}`;
            showOverlay(getText('levelComplete'), msg, getText('nextLevel'), () => { 
