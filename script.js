document.addEventListener('DOMContentLoaded', () => {
    ...
    // ---------- 2. DİL VERİLERİ (TÜM ÇEVİRİLER TAMAMLANDI) ----------
    const languageData = {
        tr: {
